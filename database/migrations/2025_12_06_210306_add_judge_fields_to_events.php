...
return new class extends Migration
{
    ...
    {
        // 1. PRIMERO: Tabla para relacionar eventos con jueces (no depende de nada)
        ...
        // 4. OPCIONAL: Agregar campo 'popular' a eventos si no existe
        if (!Schema::hasColumn('events', 'popular')) {
            Schema::table('events', function (Blueprint $table) {
                $table->boolean('popular')->default(false)->after('estado');
            });
        }
    }
