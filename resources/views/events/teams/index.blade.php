...
<x-app-layout>
    <div style="padding: 20px 40px;">
        <a href="{{ url()->previous() }}" class="btn btn-main" style="display: inline-flex; align-items: center; gap: 8px;">
            ← Regresar
        </a>
    </div>
    <div class="container">
            <h1>Equipos Inscritos en <strong>{{ $event->nombre }}</strong></h1>
            ...
            <div class="teams-grid">
                ...
                {{ $teams ->links() }}
                    <div class="empty-state">
                        ...
                        @auth
                            <a href="{{ route('teams.create') }}" class="btn btn-primary" style="margin-top: 20px;">Crear Equipo</a>
                        @endauth
                    </div>
                @endforelse
            </div>
