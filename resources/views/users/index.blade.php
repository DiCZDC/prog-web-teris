            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <option value="judge" {{ ($user->hasRole(juez)) ? 'selected' : '' }}>Juez</option>
                    </select>
                    </td>
                    <td class="text-center"><small class="text-muted">{{ optional($user->created_at)->diffForHumans() ?? '-' }}</small></td>
                    <td class="text-center">
                        <br>
                        <button class="btn btn-sm btn-primary me-1 update-role-btn" data-user-id="{{ $user->id }}">Actualizar Rol</button>
                        <br>
