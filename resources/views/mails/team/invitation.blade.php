            ...
            <table border="0" cellpadding="0" cellspacing="0" width="600" class="container" style="background-color: #ffffff; margin-top: 20px;">
                ...
                <tr>
                    <td colspan="2" class="content-padding" style="padding: 30px 0; text-align: left; color: #1c1c1c; font-size: 14px; line-height: 21px;">
                        ...
                        <h2 style="font-size: 18px; margin: 0 0 15px 0; font-weight: bold;">Has sido invitado a unirte a {{$teamName}}</h2>
                        <img src ="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExcXN4ZGY1NWh4b2tpZ2RnbHkwNDJ1Njc2MDc3MHh3NmRwYnZobnlyaSZlcD12MV9naWZzX3NlYXJjaCZjdD1n/osmd7fdUw3VymKggG5/giphy.gif" style="width: 100%; max-width: 600px; height: auto; display: block; margin-bottom: 20px; border-radius: 8px;">
                        <p style="margin-bottom: 15px;">
                            El equipo <strong>{{$teamName}}</strong> te ha enviado una invitación para unirte a ellos. 
                            Recuerda colaborar con tus compañeros de equipo y aprovechar al máximo esta experiencia.
                            Confirmar tu participación lo antes posible a través de <strong>Teris</strong>.
