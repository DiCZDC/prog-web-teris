            ...
            <table border="0" cellpadding="0" cellspacing="0" width="600" class="container" style="background-color: #ffffff; margin-top: 20px;">
                ...
                <tr>
                    <td colspan="2" class="content-padding" style="padding: 30px 0; text-align: left; color: #1c1c1c; font-size: 14px; line-height: 21px;">
                        ...
                        <h2 style="font-size: 18px; margin: 0 0 15px 0; font-weight: bold;">Has recibido una respuesta a tu invitación</h2>
                        <img src ="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExN3p2dmlsOHFqNjRvMGowangwM2hvMWEzdGc2OXVxdGUzNWJrdzN3YiZlcD12MV9naWZzX3NlYXJjaCZjdD1n/l2JdZJRX911fF1pWE/giphy.gif" style="width: 100%; max-width: 600px; height: auto; display: block; margin-bottom: 20px; border-radius: 8px;">
                        <p style="margin-bottom: 15px;">
                            La invitación que has enviado a {{$teamMemberName}} para unirse a tu equipo {{$teamName}} ha sido {{$response}}.
